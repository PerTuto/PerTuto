...
type AddLeadFormProps = {
  addLead: (lead: Omit<Lead, 'id' | 'dateAdded' | 'status'>) => void;
...
export function AddLeadForm({ addLead, setIsAddDialogOpen }: AddLeadFormProps) {
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <FormField control={form.control} name="notes" render={({ field }) => (
          <FormItem>
            ...
            <FormControl><Textarea placeholder="Any relevant notes about this lead..." {...field} /></FormControl>
            <FormMessage />
          </FormItem>
        )}
        />
