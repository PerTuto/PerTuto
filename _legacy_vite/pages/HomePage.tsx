...
export const HomePage = () => {
    ...
    const [faqs, setFaqs] = useState([
        ...
        },
        {
            ...
            answer: 'We specialize in IB, A-Levels, AP, and IGCSE curriculums across Maths, Sciences, English, and Computer Science.',
            open: false
        }
    ]);
    ...
    return (
        <>
                                ...
                                {isSchool ? (
                                    ...
                                    <>
                                        ...
                                        <DecryptedText
                                            text="YOUR CAREER"
                                            speed={40}
                                            className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-[#DB2777] via-[#7C3AED] to-[#DB2777] whitespace-nowrap"
                                        />
                                    </>
                                )}
                            </h1>
            ...
            {/* Marquee */}
            <Marquee items={isSchool
                ? ["MATH", "PHYSICS", "CHEMISTRY", "BIOLOGY", "CODING", "HISTORY", "ECONOMICS", "LITERATURE", "PSYCHOLOGY"]
                : ["SYSTEM DESIGN", "DATA STRUCTURES", "REACT", "NEXT.JS", "PYTHON", "SQL", "CLOUD ARCHITECTURE", "LEADERSHIP", "AGILE"]
            } />
            ...
            <section id="how-it-works" className="py-24 px-6 relative overflow-hidden">
                <div className="container mx-auto max-w-6xl relative z-10">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <SpotlightCard className="bg-gradient-to-br from-[#1a1a1a] to-black aspect-square flex items-center justify-center relative p-0 overflow-hidden">
                            <div className="absolute inset-0 bg-cover bg-center opacity-40 mix-blend-screen rounded-3xl" style={{ backgroundImage: "url('/src/assets/how-it-works-abstract.svg')" }}></div>
