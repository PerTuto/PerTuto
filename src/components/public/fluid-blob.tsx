...
export function FluidBlob() {
    return (
        <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
            ...
            <div
                className="absolute -top-20 -start-20 w-[500px] h-[500px] animate-blob opacity-[0.12]"
                style={{
            ...
            <div
                className="absolute top-10 end-0 w-[400px] h-[400px] animate-blob opacity-[0.15]"
                style={{
            ...
            <div
                className="absolute -bottom-10 start-1/3 w-[350px] h-[350px] animate-blob opacity-[0.06]"
                style={{
