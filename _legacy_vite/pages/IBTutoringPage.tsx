...
export const IBTutoringPage = () => {
    ...
    const subjects = [
        { name: 'Maths AA HL/SL', icon: '∫', desc: 'Analysis & Approaches. Calculus, algebra, and proof mastery.' },
        { name: 'Maths AI HL/SL', icon: '📊', desc: 'Applications & Interpretation. Statistics and modelling focus.' },
