                ...
                <nav className="bg-white/50 dark:bg-black/50 backdrop-blur-lg border-b border-black/5 dark:border-white/10 w-full">
                    <div className="container mx-auto px-6 h-20 flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            ...
                            <button onClick={() => scrollToSection(isSchool ? 'features' : 'how-it-works')} className="text-sm font-medium text-gray-400 hover:text-white transition-colors">
                ...
                <div className="container mx-auto max-w-6xl">
                    <div className="grid md:grid-cols-4 gap-8 mb-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
                                <li><Link to="/resources" className="hover:text-[#7C3AED] dark:hover:text-white transition-colors">Study Library</Link></li>
                                <li><Link to="/grade-calculator" className="hover:text-[#7C3AED] dark:hover:text-white transition-colors">Grade Calculator</Link></li>
