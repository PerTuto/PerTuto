import { collection, doc, getDoc, getDocs, query, where, addDoc, writeBatch, arrayRemove, arrayUnion, Timestamp, deleteDoc } from 'firebase/firestore';
...
/**
 * Deletes a course. Backend Firestore triggers handle the cascading deletion of classes, assignments, and student unenrollments.
 */
