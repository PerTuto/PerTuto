            ...
            <div className="container mx-auto max-w-7xl px-4 flex items-center justify-between gap-4">
                <div className="flex items-center gap-3 flex-1">
                    ...
                    <p className="text-sm md:text-base font-medium">
                        <span className="font-bold">🎯 Exam Crash Course:</span> Get a full 60-min diagnostic session + study plan for just <span className="font-bold text-red-600">$100</span>.
                    </p>
                </div>
